...
} from '../models/registries.models';
import { MarketPlaceFormModel } from '../models/registries.models';

/**
 * Async Custom Actions
 */
const sendObjects: AsyncThunk<any, { data: ObjectFormModel }, {}> =
  createAsyncThunk<any, { data: ObjectFormModel }>(
    'POST/objectsSend',
    async (data, _) => {
...
const sendMarketPlace: AsyncThunk<any, { data: MarketPlaceFormModel }, {}> =
  createAsyncThunk<any, { data: MarketPlaceFormModel }>(
...
const createTypePriceList: AsyncThunk<any, { data: PointOfSaleFormModel }, {}> =
  createAsyncThunk<any, { data: PointOfSaleFormModel }>(
...
const createPriceList: AsyncThunk<any, { data: PointOfSaleFormModel }, {}> =
  createAsyncThunk<any, { data: PointOfSaleFormModel }>(
    'POST/createTypePriceListSend',
    async (data, _) => {
...
const sendPointOfSales: AsyncThunk<any, { data: PointOfSaleFormModel }, {}> =
  createAsyncThunk<any, { data: PointOfSaleFormModel }>(
...
const sendWarehouse: AsyncThunk<any, { data: WarehouseFormModel }, {}> =
  createAsyncThunk<any, { data: WarehouseFormModel }>(
    'POST/warehouseSend',
    async (data, _) => {
...
const sendUnit: AsyncThunk<any, { data: UnitFormModel }, {}> = createAsyncThunk<
  any,
  { data: UnitFormModel }
>('POST/unitSend', async (data, _) => {
  return await RegistriesPublicService.sendUnit(data)
    .then((res: any) => 'sucsses')
    .catch((err: any) => 'error');
});

const sendGroup: AsyncThunk<any, { data: GroupFormModel }, {}> =
  createAsyncThunk<any, { data: GroupFormModel }>(
    'POST/groupSend',
    async (data, _) => {
...
const sendVat: AsyncThunk<any, { data: VatFormModel }, {}> = createAsyncThunk<
  any,
  { data: VatFormModel }
>('POST/vatSend', async (data, _) => {
  return await RegistriesPublicService.sendVat(data)
    .then((res: any) => 'sucsses')
    .catch((err: any) => 'error');
});

const sendUsers: AsyncThunk<any, { data: UsersFormModel }, {}> =
  createAsyncThunk<any, { data: UsersFormModel }>(
    'POST/usersSend',
    async (data, _) => {
...
const getObjects: AsyncThunk<any, { companyId: number | string }, {}> =
...
const getPointOfSales: AsyncThunk<any, { companyId: number | string }, {}> =
  createAsyncThunk<any, { companyId: number | string }>(
    'GET/pointOfSales',
    async (params) => {
...
const getCompaniesDistributor: AsyncThunk<
  any,
...
const sendCompanies: AsyncThunk<
  any,
  { data: CompanyFormModel; listPayeeFinancialAccount: any[] },
  {}
> = createAsyncThunk<
  any,
  { data: CompanyFormModel; listPayeeFinancialAccount: any[] }
>('POST/companySend', async (data, _) => {
  const idDistributor = data.data?.distributor?.item?.idDistributor
    ? data.data?.distributor?.item?.idDistributor
...
const sendDistributor: AsyncThunk<any, { data: DistributorFormModel }, {}> =
  createAsyncThunk<any, { data: DistributorFormModel }>(
    'POST/companySend',
    async (data, _) => {
...
const sendDistributorCompany: AsyncThunk<
  any,
  { companyId: number | string; idDistributor?: number | string },
  {}
> = createAsyncThunk<
  any,
  { companyId: number | string; idDistributor?: number | string }
>('POST/distributorCompanySend', async (data, _) => {
  return await RegistriesPublicService.sendDistributorCompany(
    data.companyId,
    data.idDistributor
  )
    .then((res: any) => ({ message: 'sucsses', data: res.data }))
...
const sendsubscribe: AsyncThunk<any, { data: CompanyFormModel }, {}> =
  createAsyncThunk<any, { data: CompanyFormModel }>(
    'POST/subscribeSend',
    async (data, _) => {
...
const sendsubscribeUpdate: AsyncThunk<any, { data: CompanyFormModel }, {}> =
  createAsyncThunk<any, { data: CompanyFormModel }>(
    'POST/subscribeSend',
    async (data, _) => {
...
const getWarehouses: AsyncThunk<any, { uuid: string }, {}> = createAsyncThunk<
  any,
  { uuid: string }
>('GET/Warehouses', async (params) => {
...
const getUsers: AsyncThunk<any, { companyId: number | string }, {}> =
  createAsyncThunk<any, { companyId: number | string }>(
    'GET/Users',
    async (params) => {
...
const updateCompanies: AsyncThunk<
  any,
  { idCompany: number | string; data: any; idpayeeFinancialAccountDto: any[] },
  {}
> = createAsyncThunk<
  any,
  { idCompany: number | string; data: any; idpayeeFinancialAccountDto: any[] }
>('GET/subjectupdate', async (params, _) => {
  return await RegistriesPublicService.updateCompanies(
    params.idCompany,
    params.data
  )
    .then((res: any) => {
      if (true) {
        _.dispatch(
          updatePayee({
            ...
            idpayeeFinancialAccountDto: params?.idpayeeFinancialAccountDto,
          })
        );
      }
      return { message: 'sucsses', data: res.data };
...
const updatePayee: AsyncThunk<
  any,
  { idCompany: number | string; idpayeeFinancialAccountDto: any[] },
  {}
> = createAsyncThunk<
  any,
  { idCompany: number | string; idpayeeFinancialAccountDto: any[] }
>('GET/updatePayee', async (params) => {
  return await RegistriesPublicService.updatePayee(
    params.idCompany,
...
const updateUser: AsyncThunk<any, { id: number | string; data: any }, {}> =
  createAsyncThunk<any, { id: number | string; data: any }>(
    'GET/userUpdate',
    async (params) => {
...
const getGroups: AsyncThunk<any, { uuid: number | string }, {}> =
...
const getSync: AsyncThunk<any, { apiKey: string }, {}> = createAsyncThunk<
  any,
  { apiKey: string }
>('GET/getSync', async (params) => {
