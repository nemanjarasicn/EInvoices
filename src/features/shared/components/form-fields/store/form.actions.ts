 ...
 * Get Async Companies
 */
const getCompaniesAll: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/CompaniesAll',
  async () => {
 ...
 */
const getSubjectCategory: AsyncThunk<any, void, {}> = createAsyncThunk(
 ...
 */
const getSubjectType: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/subjectTypeget',
  async () => {
 ...
 * Get Async Units
 */
const getUnitsAll: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/unitsAll',
  async () => {
 ...
 */
const getDistributor: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/distributorget',
  async () => {
 ...
 * Get Async taxCode
 */
const getTaxCode: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/taxCodeget',
  async () => {
 ...
 * Get Async Vat
 */
const getVatAll: AsyncThunk<any, void, {}> = createAsyncThunk(
  'GET/vatAll',
  async () => {
