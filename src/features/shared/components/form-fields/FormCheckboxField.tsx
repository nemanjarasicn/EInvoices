    ...
    <Controller
      ...
      render={({ field: { onChange, value }, fieldState: { error } }) => (
        <FormControlLabel
          ...
          label={props.label}
          sx={{
            color: props.additional?.color ? props.additional.color : 'white',
            '& .MuiFormControlLabel-label': { fontSize: fontSizeCheckbox },
          }}
          control={
            <Checkbox
              {...props}
              ...
              sx={{
                color: props.additional?.color
                  ? props.additional.color
                  : 'white',
                '&.Mui-checked': { color: '#6cb238' },
                '& .MuiSvgIcon-root': { fontSize: widthCheckbox },
              }}
            />
          }
        />
