  ...
  <Fragment>
    <View style={styles.container}>
        ...
        <View style={styles.clientContainer}>
          <View style={styles.textConteiner}>
            <Text style={styles.name}>
              {data?.AccountingCustomerParty?.name}
            </Text>
          </View>
          <View style={styles.textConteiner}>
            <Text style={styles.adress}>
              {data?.AccountingCustomerParty?.adress}
            </Text>
          </View>
          <View style={styles.textConteiner}>
            <Text style={styles.city}>
              {data?.AccountingCustomerParty?.city}
            </Text>
          </View>
        </View>
      </View>
      <View style={styles.section2}>
        ...
        <View style={styles.invoiceLabelNo}>
          <Text style={styles.invoiceNo}>{data?.numberDocument}</Text>
        </View>
        <View style={styles.invoiceDataConteiner}>
          <View style={styles.textConteiner}>
            <Text style={styles.dataTextLeft}>
              Uplatu izvrsiti sa uplatom na broj
            </Text>
          ...
          <View style={styles.textConteiner}>
            ...
            <Text style={styles.dataTextRight}>
              {data?.AccountingCustomerParty?.mb}
            </Text>
          </View>
          <View style={styles.textConteiner}>
            <Text style={styles.dataTextLeft}>PIB kupca</Text>
            <Text style={styles.dataTextRight}>
              {data?.AccountingCustomerParty?.pib}
            </Text>
          </View>
          <View style={styles.textConteiner}>
          ...
          <View style={styles.textConteiner}>
            ...
            <Text style={styles.dataTextRightBold}>
              {currencyFormat(Number(data?.legalMonetaryTotal?.payableAmount))}
            </Text>
          </View>
        </View>
      </View>
